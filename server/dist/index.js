...
var init = function () { return __awaiter(void 0, void 0, void 0, function () {
    var prisma, pubSub, app, httpServer, schema, server, subscriptionServer;
        ...
        switch (_a.label) {
            case 0:
                ...
                server = new apollo_server_express_1.ApolloServer({
                    ...
                    context: function (_a) {
                        var req = _a.req;
                        return __assign(__assign({}, req), { prisma: prisma, pubSub: pubSub, user: req.headers.authorization });
                    }
                });
            ...
            case 1:
                ...
                subscriptionServer = subscriptions_transport_ws_1.SubscriptionServer.create({
                    ...
                    onConnect: function (connectionParams, webSocket, context) {
                        ...
                        return __assign(__assign({}, context), { conectadoWS: true, pubSub: pubSub, user: connectionParams.headers.authorization });
                    }
                }, {
                    server: httpServer,
                    path: server.graphqlPath
                });
                httpServer.listen(4000, function () { return console.log("server ready"); });
                return [2 /*return*/];
        }
    });
}); };
